<template>
 <div>
   ...
   <div class="infor_form">
	   ...
	   <div class="form_input">
		   <input type="radio" name="sex" class="input_radio">男
		   <input type="radio" name="sex" class="input_radio">女
	   </div>
	   </div>
	   <div class="form_div">
...
.infor_form .form_div .form_title{float: left;
    ...
    font-size: 0.3rem;
	text-align: left;}
.infor_form .form_input{float: left;width:60%; display: inline-block;}
